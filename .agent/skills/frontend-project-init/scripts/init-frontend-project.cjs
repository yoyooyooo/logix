...
if (!targetArg) {
  console.error('用法: node .agent/skills/frontend-project-init/scripts/init-frontend-project.cjs <target-dir> [template-id]')
  console.error('示例: node .agent/skills/frontend-project-init/scripts/init-frontend-project.cjs examples/my-sandbox')
  process.exit(1)
}
