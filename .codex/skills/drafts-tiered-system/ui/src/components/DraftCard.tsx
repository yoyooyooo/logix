    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap items-center gap-2 text-[10px] font-medium">
                {/* Spec ID Badge */}
                {draft.id && (
                    <Badge variant="secondary" className="rounded-full border-border font-mono text-[10px]">
                        ID {draft.id}
                    </Badge>
                )}
                ...
                {typeof draft.priority === 'number' ? (
                    <Badge variant="secondary" className="rounded-full border-border text-[10px]">
                        #{draft.priority}
                    </Badge>
                ) : (
                    draft.priority !== '-' && (
