...
const usage = (): string => `\
Usage:
  pnpm perf capacity:probe -- [options]
...
Examples:
  ...
  pnpm perf capacity:probe -- --report perf/capacity/capacity.raw.default.json
`
...
const main = async (): Promise<void> => {
  ...
  const payload = {
    ...
    meta: {
      ...
      generator: '.codex/skills/logix-perf-evidence/scripts/capacity.probe.ts',
      profile: args.profile,
      suiteId: args.suiteId,
      budgetId: args.budgetId,
      scope: {
