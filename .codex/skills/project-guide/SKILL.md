---
name: project-guide
description: 在 intent-flow 仓库做架构/规划/Runtime/示例/日常开发时，用最短导航定位新 docs 根骨架、legacy 历史基线、代码落点与质量门
---
...
| 查历史上下文 | `docs/legacy/README.md` | `docs/legacy/**` |
