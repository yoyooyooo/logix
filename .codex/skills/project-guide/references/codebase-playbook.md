...
> 约定：每条链路都给出“最短三跳”。需要按维度建立广度脉络时，从 `references/long-chain-index.md` 进入。
...
> 更完整的“检索链路压缩包”见：`.codex/skills/project-guide/references/auggie-playbook.md`。

- `优先在 .codex/skills/project-guide/references/codebase-playbook.md 与 runtime-logix/** 中定位“Bound API $ / Fluent DSL”的入口与测试文件路径，并给出 5 个最相关的路径。`
