...
- **E/F/G｜观测/证据/回放（Observability / Evidence / Replay）**：
  ...
  - **合并说明**：文档侧只维护单文件 `references/long-chain-efg-observability-evidence-replay.md`，不要再拆成独立的 E/F/G 文件。
...
- `references/long-chain-a-data-plane.md`
- `references/long-chain-b-execution-plane.md`
- `references/long-chain-c-module-graph-plane.md`
- `references/long-chain-d-effect-plane.md`
- `references/long-chain-efg-observability-evidence-replay.md`
- `references/long-chain-h-program-runner.md`
- `references/long-chain-i-sandbox-alignment-lab.md`
- `references/long-chain-j-test-plane.md`
- `references/long-chain-k-feature-kits.md`
...
2. 打开对应 `references/long-chain-*.md`，按“三跳入口（public → internal → tests）”进场。
3. 需要补基线时走 `project-guide:baseline`（见 `/Users/yoyo/.codex/prompts/project-guide.baseline.md`）。
