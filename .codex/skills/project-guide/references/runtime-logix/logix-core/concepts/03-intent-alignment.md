...
| `LogicImplConfig.testCases`                                                          | `@logixjs/test` / Round-trip 测试                                                | 平台可将这些用例转换为基于 Logix ModuleRuntime 的 Round-trip 测试（参见 `runtime-logix/test` 系列文档），通过注入 Mock Services、构造输入、断言 State/Signals。                                                                                                             |
