...
最终结果是在某个 feature 下生成一个或多个 Logix Module 定义 + Logic 配置（或 JSON DSL），由 UI 通过 `@logix/react` 适配层接入。
...
| :----------------------------------------------------------------------------------- | :----------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `IntentSpec.ui[*]`（UI Intent 节点）                                                 | Module 使用侧（UI 层）                                                         | 由平台生成的 React 组件树，通过 `@logix/react` 订阅某个 ModuleRuntime 的状态、派发 Actions；Logix 不直接建模 UI 节点，只消费其发出的事件。                                                                                                                                  |
