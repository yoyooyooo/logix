...
3. **Execute plan workflow**: Follow the structure in IMPL_PLAN template to:
   ...
   - Apply the repo planning granularity rule: freeze owner boundaries, non-goals, quality gates, proof obligations, performance / memory / diagnostics constraints, landing zones and writeback targets; avoid pseudo-code, exact algorithms or line-by-line coding recipes unless needed to remove a concrete DTO / wire / lifecycle / handoff / persistence / security / measurement ambiguity
