...
- refactor-logix-core-debugsink-record-dispatch-fastpath-20260224.md：Debug.record 热路径收敛并锁定错误传播（分支 refactor/logix-core-debugsink-record-dispatch-fastpath，PR 待创建）
