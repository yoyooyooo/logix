...
Tasks are written for a high-intelligence implementation Agent: include outcome, file path, dependency,
proof and writeback target; avoid pseudo-code or line-by-line algorithm steps unless an exact contract
has already been frozen in `implementation-details/*contract*.md`.
