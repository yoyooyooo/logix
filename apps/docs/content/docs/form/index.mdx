---
title: Form
description: "Learn @logix/form step by step: model, validation, field arrays, and performance guidance."
---

`@logix/form` is the “form domain package” in the Logix ecosystem. It hosts a form’s **values / errors / UI / submit state** as a regular module inside the Runtime, so your form and the rest of your application share the same:
