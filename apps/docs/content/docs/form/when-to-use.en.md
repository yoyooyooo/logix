...
When your form has these traits, `@logix/form` tends to make life easier:

| Trait                               | Plain Module              | @logix/form                         |
| ----------------------------------- | ------------------------- | ----------------------------------- |
...
| **Cross-field linkage/derivations** | hand-written watchers     | declarative traits                  |
