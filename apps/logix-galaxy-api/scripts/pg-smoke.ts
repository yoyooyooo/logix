...
import { EffectApiBase } from '../src/app/effect-api.js'
...
import { TodoTableLive } from '../src/todo/todo.table.live.js'
...
try {
  ...
  const found = (listJson as Array<any>).find((t) => t && t.id === id)
  assert.ok(found)
