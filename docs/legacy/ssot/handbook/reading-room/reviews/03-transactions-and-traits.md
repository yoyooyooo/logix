...
补充：`specs/007-unify-trait-system/review.md` 的残留 `[Next]`（Form errors 事实源口径、SC-005 基准、EvidencePack E2E 回放闭环）已合并进 `docs/ssot/handbook/reading-room/reviews/99-roadmap-and-breaking-changes.md` 的 Phase 1/2。
