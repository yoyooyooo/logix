...
- 运行时契约/语义口径（SSoT）：`docs/ssot/runtime/logix-core/runtime/*`、`docs/ssot/runtime/logix-core/concepts/*`、`docs/ssot/runtime/logix-core/observability/*`。
- 平台级硬约束（如事务窗口禁止 IO/等待）：`docs/ssot/platform/contracts/00-execution-model.md`。
