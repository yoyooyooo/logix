...
| [scenario-playground-alignment-proposal.md](./scenario-playground-alignment-proposal.md) | `trial --mode scenario` 与 Playground scenario metadata 的 reviewed alignment proposal |
