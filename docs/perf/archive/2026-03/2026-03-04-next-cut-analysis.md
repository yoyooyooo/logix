...
- 后续切刀已推进：
  - B-1：externalStore 写回批处理（in-flight batching）：`docs/perf/archive/2026-03/2026-03-04-b1-externalStore-batched-writeback.md`
-  - C-1：`Ref.list(...)` 自动增量（txn evidence -> changedIndices）：`docs/perf/archive/2026-03/2026-03-04-c1-ref-list-auto-incremental.md`
