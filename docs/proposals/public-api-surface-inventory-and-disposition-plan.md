...
- 实际完成：
  ...
  - `examples/logix`、`examples/logix-react`、`examples/logix-sandbox-mvp` 与 `apps/docs/content/docs/guide/recipes/unified-api*` 的旧 support surface 写法已迁到当前 owner；`examples/logix-form-poc` 已在 2026-05-11 single-track cutover 中从 live source 删除
