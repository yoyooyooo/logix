...
> **Status**: Draft（部分内容已落地到 @logixjs/react 与 `docs/ssot/runtime/logix-react`）
> **Date**: 2025-11-21
> **Layer**: Integration Layer
...
*   [03-concurrent-rendering.md](./03-concurrent-rendering.md): 并发渲染与 tearing-free 保证。
*   [04-ssr-and-testing.md](./04-ssr-and-testing.md): SSR / Hydration / 测试策略。
*   [05-runtime-config-overrides.md](./05-runtime-config-overrides.md): runtime 级 React 配置覆盖与安全边界（Snapshot）。
*   [06-no-useeffect-gaps.md](./06-no-useeffect-gaps.md): 业务组件“无 useEffect / useRef”目标与缺口分类。
