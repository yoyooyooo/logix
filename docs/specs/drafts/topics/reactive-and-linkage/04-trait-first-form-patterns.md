...
related:
  ...
  - ./02-dynamic-list-and-linkage.md
  - ./03-unified-resource-field.md
---
...
- 基础约束（承接 `003-trait-txn-lifecycle` 特性）：
...
3. **未来工作建议（非本轮范围）**：
   ...
   - 在 `reactive-and-linkage` Topic 中，未来可增加「DynamicList / FormState Helper 设计」草案，将当前 Trait/事务规范映射成具体 Helper API；  
