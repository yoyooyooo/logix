...
| 规范                                                                                                                                                                   | 关系                                                          |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| [v3 code-runner-and-sandbox.md](file:///Users/yoyo/Documents/code/personal/intent-flow/docs/specs/intent-driven-ai-coding/v3/platform/impl/code-runner-and-sandbox.md) | 本文档是其「细化与补充」，对齐 Frontend First 决策            |
| runtime-logix/core                                                                                                                                                     | Sandbox 复用 `Platform.Service` / Tracer / Observability 插件 |
