...
> 关联文档：  
> - `docs/specs/intent-driven-ai-coding/v3/01-overview.md`（平台整体愿景）  
> - `docs/specs/intent-driven-ai-coding/v3/06-platform-ui-and-interactions.md`（Universe/Galaxy/Studio 视图）  
> - `docs/specs/intent-driven-ai-coding/v3/platform/README.md`（IntentRule / R-S-T 模型）  
> - `docs/specs/runtime-logix/core/*`（Module / Logic / Flow / Runtime 契约）  
