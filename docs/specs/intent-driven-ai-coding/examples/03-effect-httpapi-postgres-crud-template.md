...
- 表结构 SSoT（示例）：`docs/specs/intent-driven-ai-coding/examples/02-logix-galaxy-api-postgres.md`
...
1. 表结构 SSoT 文档（建议放在 `docs/specs/intent-driven-ai-coding/examples/<nn>-*.md`）
