...
const ParallelLoadConfigSchema = Schema.Struct({
  userId: Schema.String
});

export type ParallelLoadConfig = Schema.Schema.Type<typeof ParallelLoadConfigSchema>;

export const ParallelLoadPattern = definePattern<ParallelLoadConfig>({
  id: "poc/parallel-load",
  version: "1.0.0",
  tags: ["parallel", "load"],
  config: ParallelLoadConfigSchema,
  body: config =>
