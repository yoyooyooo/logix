...
import {
  ButtonSubmitFlowPattern,
  type ButtonSubmitFlowConfig
} from "../patterns/button-submit-flow";
...
const program = Effect.gen(function*(_) {
  ...
  const buttonConfig: ButtonSubmitFlowConfig = {
    event: "button:submit",
    service: "OrderService",
    method: "submit"
  };
  yield* dsl.run(ButtonSubmitFlowPattern, buttonConfig);
