...
export const RegionShippingLink = Logix.Link(
  {
    region: RegionModule,
    cart: CartModule,
  },
...
// ---------------------------------------------------------------------------
// 5. Live Layers & Runtime Composition
// ---------------------------------------------------------------------------

export const RegionLive = RegionModule.live(
  { province: undefined },
  RegionLogic
)

export const CartLive = CartModule.live(
  { items: [], shippingFee: 0 },
  CartLogic
)
