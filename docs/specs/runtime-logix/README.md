...
- Logix 实现者 / 运行时维护者  
  ...
  以 `core/02-logix-design.md`、`core/06-implementation-architecture.md`、`core/07-usage-guidelines.md`、`core/08-debugging-features.md`、`core/09-logix-v2-capabilities.md` 为主轴。
