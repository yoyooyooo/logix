...
- `05-working-with-effect-flow-runtime.md`  
  说明如何在 Logix 中触发服务侧 Flow（Effect Flow Runtime），以及如何回填状态、展示执行结果，对应 `docs/specs/intent-driven-ai-coding/v3/97-effect-runtime-and-flow-execution.md` 的 Runtime 家族说明。
