...
>
> 本文是 **愿景 + 交互** 的 SSoT 入口；形式化模型与符号表见 `docs/specs/sdd-platform/ssot/foundation/01-the-one.md`（含 “3.1 $\Sigma_t=(S_t,I_t)$” 与 Tape 口径）。
...
> Tape 的最小口径（program 侧）见：`specs/075-logix-flow-program-ir/contracts/tape.md`。
