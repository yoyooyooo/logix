...
> 用途：在不通读 `docs/ssot/handbook/reading-room/long-chain/long-chain-*.md` 的前提下，快速建立“运行时总骨架 + 必要不变量 + 常用机制”的心智模型；细节以各平面文档与代码为准。
...
- 正交分解索引（A–K）：`long-chain-index.md`
- 导览（从业务写法到实现落点）：`docs/ssot/runtime/logix-core/concepts/02-long-chain-tour.md`
- 数据/性能：`docs/ssot/handbook/reading-room/long-chain/long-chain-a-data-plane.md`、`docs/ssot/handbook/playbooks/diagnostics-perf-baseline.md`
- 执行/并发：`docs/ssot/handbook/reading-room/long-chain/long-chain-b-execution-plane.md`
- 副作用/平台桥：`docs/ssot/handbook/reading-room/long-chain/long-chain-d-effect-plane.md`
- 观测/证据/回放：`docs/ssot/handbook/reading-room/long-chain/long-chain-efg-observability-evidence-replay.md`

---

## 5) 长链路专用 auggie 查询模板（复制即用）

> 更完整模板见：`docs/ssot/handbook/cheatsheets/auggie-playbook.md`。
