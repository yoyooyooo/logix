...
> 更完整的“检索链路压缩包”见：`docs/ssot/handbook/auggie-playbook.md`。

- `优先在 docs/ssot/handbook/codebase-playbook.md 与 docs/ssot/runtime/** 中定位“Bound API $ / Fluent DSL”的入口与测试文件路径，并给出 5 个最相关的路径。`
