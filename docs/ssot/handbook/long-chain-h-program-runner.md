...
- **internal**
  - `packages/logix-core/src/internal/runtime/runner/ProgramRunner.ts`
  - 相关模块：`packages/logix-core/src/internal/runtime/runner/ProgramRunner.errors.ts`、`ProgramRunner.signals.ts`、`ProgramRunner.exitCode.ts`
- **tests**
  - `packages/logix-core/test/Runtime.runProgram.basic.test.ts`
  - `packages/logix-core/test/Runtime.runProgram.signals.test.ts`
  - `packages/logix-core/test/Runtime.runProgram.disposeTimeout.test.ts`
