...
我们将 GitHub Spec Kit 定义的四阶段工作流 (Specify -> Plan -> Tasks -> Implement) 映射到 Intent 模型的逐层展开过程（L0/L1/L2/L3 的详细定义见 `docs/ssot/platform/foundation/03-trinity-and-layers.md`）。
