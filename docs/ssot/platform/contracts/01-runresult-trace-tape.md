...
- Tape（可回放磁带：Record/Replay/Fork）：`specs/075-flow-program-codegen-ir/contracts/tape.md`
...
这就是 `docs/ssot/platform/foundation/01-the-one.md` 中 “开放系统与 Tape” 的工程含义：时间旅行不是“重发 IO 回到过去”，而是“用 tape 事件重放同一条因果链”。
