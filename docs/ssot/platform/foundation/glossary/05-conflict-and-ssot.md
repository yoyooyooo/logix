...
2. **运行时术语与契约：优先查 runtime SSoT**：
   - `docs/ssot/runtime/logix-core/concepts/10-runtime-glossary.md`
   - `docs/ssot/runtime/logix-core/*`

3. **其次查模型与协议层文档**：
   - 三位一体与资产结构：`docs/ssot/platform/foundation/03-trinity-and-layers.md`、`docs/ssot/platform/assets/00-assets-and-schemas.md`；
