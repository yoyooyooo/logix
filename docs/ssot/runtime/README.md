...
| [18-runtime-inspect-evidence-contract.md](./18-runtime-inspect-evidence-contract.md) | 172 之后 live runtime evidence / causal debug record 的 owner law、coordination law、dependency backlog 与 proof obligation | `173 + 174/175/176/177/178/179/180/183` |
...
- Runtime inspect evidence 合同：`18-runtime-inspect-evidence-contract.md`
