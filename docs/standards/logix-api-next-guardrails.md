...
- harness、proof、fixture、support 与 coverage inventory 的存放、命名、编号追溯和顺手纠偏统一看 [Harness And Proof Assets Standard](./harness-and-proof-assets-standard.md)
- `src/**` 禁止承接 spec 编号矩阵、planning row helper、temporary probe/witness/pressure helper 或 coverage inventory truth
...
- [./harness-and-proof-assets-standard.md](./harness-and-proof-assets-standard.md)
