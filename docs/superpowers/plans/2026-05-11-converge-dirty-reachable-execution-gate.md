# Converge Dirty-Reachable Execution Gate Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Ensure exact dirtyPlan drives converge dirty-reachable execution instead of full topo execution.
...
- Create: `packages/logix-core/test/FieldKernel/FieldKernel.Converge.DirtyReachableExecution.contract.test.ts`
...
- Modify: `packages/logix-core/src/internal/field-kernel/converge.types.ts`
- Modify: `packages/logix-core/src/internal/field-kernel/converge-legacy-dirty-adapter.ts`
