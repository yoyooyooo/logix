# FieldKernel Fallback Reason Tax Report Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create unified field-kernel fallback reason reporting and tax migration classifier.
...
- Create: `packages/logix-perf-evidence/scripts/ci.field-kernel-dirty-work-tax-report.ts`
- Create: `packages/logix-perf-evidence/scripts/ci.field-kernel-dirty-work-tax-report.test.ts`
- Create: `docs/next/field-kernel-dirty-work-tax-migration-report-template.md`

### Modify

- Modify: `packages/logix-core/src/internal/runtime/core/kernelFallbackReason.ts`
- Modify: `packages/logix-core/test/Contracts/KernelFallbackReason.contract.test.ts`
