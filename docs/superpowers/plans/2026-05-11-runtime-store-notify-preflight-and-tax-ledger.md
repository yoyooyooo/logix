# RuntimeStore Notify Preflight and Tax Ledger Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Map the RuntimeStore / selector notify path and produce a preflight ledger that future specs must use.
...
- Create: `docs/next/runtime-store-selector-notify-tax-ledger.md`
- Create: `specs/213-runtime-store-notify-preflight-and-tax-ledger/notes/entrypoints.md`
