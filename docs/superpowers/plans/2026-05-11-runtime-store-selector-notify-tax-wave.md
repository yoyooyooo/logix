# RuntimeStore Selector Notify Tax Wave Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Coordinate a focused RuntimeStore / selector notification fanout wave without reopening dispatch shell fixed-cost work.
...
- Create: `docs/next/runtime-store-selector-notify-tax-wave.md`
- Create: `docs/next/runtime-store-selector-notify-evidence-protocol.md`
