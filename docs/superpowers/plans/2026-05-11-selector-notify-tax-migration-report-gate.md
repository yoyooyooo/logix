# Selector Notify Tax Migration Report Gate Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Make selector notify outcomes classifiable as tax_removed, tax_migrated, stable_guarded, inconclusive, or failed.
...
- Create: `packages/logix-perf-evidence/scripts/ci.selector-notify-tax-report.ts`
- Create: `packages/logix-perf-evidence/scripts/ci.selector-notify-tax-report.test.ts`
- Create: `docs/next/runtime-store-selector-notify-tax-migration-report-template.md`
