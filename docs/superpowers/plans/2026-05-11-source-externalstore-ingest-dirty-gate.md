# Source ExternalStore Ingest Dirty Gate Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Ensure source/externalStore ingest avoids unrelated work while preserving scheduler/lifecycle law.
...
- Create: `packages/logix-core/test/internal/FieldKernel/FieldKernel.Source.RowScopeDirtyGate.test.ts`
