...
const LocalCounterModule = Logix.Module.make('LocalCounter', {
...
const LocalCounterLogic = LocalCounterModule.logic(($) =>
  Effect.gen(function* () {
...
const LocalCounterImpl = LocalCounterModule.implement({
  initial: { count: 0 },
