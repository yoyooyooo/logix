...
const MiddlewareCounterDef = Logix.Module.make('MiddlewareCounter', {
  state: CounterState,
  actions: CounterActions,
})

const MiddlewareCounterLogic = MiddlewareCounterDef.logic(($) =>
  Effect.gen(function* () {
...
const MiddlewareCounterModule = MiddlewareCounterDef.implement({
  initial: { count: 0 },
...
const middlewareRuntime = Logix.Runtime.make(MiddlewareCounterModule, {
...
const CounterView: React.FC = () => {
  const runtimeHandle = useModule(MiddlewareCounterDef)
