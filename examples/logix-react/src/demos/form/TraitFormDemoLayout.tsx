...
const runtime = Logix.Runtime.make(TraitFormModule, {
  label: 'TraitFormDemoRuntime',
  devtools: true,
})

const TraitFormView: React.FC = () => {
  const form = useModule(TraitFormDef)
  const state = useModule(form, (s) => s)
...
export type TraitFormDemoLayoutProps = {
  readonly layer?: Layer.Layer<any, any, never>
}

export const TraitFormDemoLayout: React.FC<TraitFormDemoLayoutProps> = ({ layer }) => {
  return (
