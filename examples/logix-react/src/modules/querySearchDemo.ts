...
export const SearchQuery = Query.make('QuerySearchDemo', {
  ...
  queries: {
    ...
    detail: {
      ...
      concurrency: 'switch',
      key: (params: Params) => (params.selectedId ? { id: params.selectedId } : undefined),
    },
  },
})

// Host Module：演示 Query module 作为“被组合的子模块”被引入到另一个 ModuleImpl 中。
...
export const QuerySearchDemoHostImpl = QuerySearchDemoHost.implement({
  initial: undefined,
...
export const queryRuntime = Logix.Runtime.make(QuerySearchDemoHostImpl, {
