...
// - 最终仍通过 `logic: $.logic({ rules })` 进入 canonical authoring path
...
const rulesCompositionMixedDefine = (form: any): void => {
  ...
  form.rules(contactSpec.decls, itemsRules(z), noteRules(z), rootRules(z))
}

export const RulesCompositionMixedForm = Form.make(
