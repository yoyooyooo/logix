...
export type TaskRunnerDemoState = Schema.Schema.Type<
  typeof TaskRunnerDemoStateSchema
>
...
export const TaskRunnerDemoModule = Logix.Module.make("TaskRunnerDemoModule", {
...
export const TaskRunnerDemoLogic = TaskRunnerDemoModule.logic(($) => ({
  setup: Effect.void,
  run: Effect.gen(function* () {
    ...
    const reset = $.onAction("reset").run(
...
export const TaskRunnerDemoImpl = TaskRunnerDemoModule.implement({
