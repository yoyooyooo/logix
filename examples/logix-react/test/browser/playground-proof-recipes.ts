...
export const logixReactPlaygroundProofRecipes = {
  ...
  'logix-react.live-bridge': {
    projectId: 'logix-react.live-bridge',
    reportLabel: 'agent live bridge dogfood route',
    proofPackIds: ['run', 'check', 'trialStartup', 'runtimeEvidenceProbe', 'gapHarvest', 'liveBridgeDogfood', 'boundaryProbe'],
  },
