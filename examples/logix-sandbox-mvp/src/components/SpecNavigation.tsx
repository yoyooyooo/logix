...
export function SpecNavigation() {
  ...
  const selectedFeatureId = useSelector(runtime, (s: any) => s.selectedFeatureId as string | null)
  const selectedStoryId = useSelector(runtime, (s: any) => s.selectedStoryId as string | null)
  const selectedScenarioId = useSelector(runtime, (s: any) => s.scenarioId as string | null)
  const selectedStepId = useSelector(runtime, (s: any) => s.selectedStepId as string | null)
