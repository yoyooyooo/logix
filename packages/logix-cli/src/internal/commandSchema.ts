export type CliCommandSchema = {
  ...
  readonly commands: ReadonlyArray<{
    readonly name: 'check' | 'trial' | 'compare' | 'live'
    readonly runtimeStage: 'check' | 'trial' | 'compare' | null
...
export const CLI_COMMAND_SCHEMA: CliCommandSchema = {
  ...
  commands: [
    ...
    },
    {
      ...
      forbiddenInputs: ['entry', 'scenario', 'beforeReport', 'afterReport', 'beforeEvidence', 'afterEvidence'],
  ...
  liveCommandResult: {
    ...
    artifactFields: ['outputKey', 'kind', 'ok', 'file', 'inline', 'digest', 'reasonCodes'],
    forbiddenFields: ['primaryReportOutputKey', 'repairHints', 'nextRecommendedStage', 'verdict'],
  },
  exitCodes: [
