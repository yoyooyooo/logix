...
import * as BoundApiRuntime from './internal/runtime/core/BoundApiRuntime.js'
 ...
 * - Optionally accepts a `ModuleTag<Sh>` to explicitly choose the runtime (e.g. cross-module collaboration).
 *
 * Note: this is a type-only surface; the concrete implementation is injected by the runtime.
 * The runtime provides the bound value at compile-time boundaries.
 */
