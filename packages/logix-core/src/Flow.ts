...
// Flow：对外暴露的业务流编排接口（封装 internal/runtime/FlowRuntime 内核）。

export type Env<Sh extends AnyModuleShape, R = unknown> = Logic.Env<
  Sh,
  R
>

export type Api<Sh extends ModuleShape<any, any>, R = never> =
  FlowRuntime.Api<Sh, R>
