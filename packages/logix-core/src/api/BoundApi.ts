...
import * as BoundApiRuntime from "../runtime/BoundApiRuntime.js"
...
export interface BoundApi<Sh extends Logix.AnyModuleShape, R = never> {
  ...
  readonly lifecycle: {
    ...
    readonly onError: (
      handler: (
        ...
        context: import("../runtime/Lifecycle.js").ErrorContext
  ...
  readonly use: {
    <Sh2 extends Logix.AnyModuleShape>(
      module: import("./Logix.js").ModuleInstance<string, Sh2>
   ...
   */
  readonly services: <Svc, Id = unknown>(
    tag: Context.Tag<Id, Svc>
  ) => Effect.Effect<Svc, never, Id>
...
export function make<Sh extends Logix.AnyModuleShape, R = never>(
  ...
  return BoundApiRuntime.make(shape, runtime)
}
