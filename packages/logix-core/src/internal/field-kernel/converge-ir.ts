...
import type { FieldEntry, FieldConvergeScheduling } from './model.js'
...
export interface ConvergeStaticIrRegistry {
   ...
   */
  readonly stepsById: ReadonlyArray<FieldEntry<any, string>>
  ...
  readonly stepSchedulingByStepId: ReadonlyArray<FieldConvergeScheduling>
