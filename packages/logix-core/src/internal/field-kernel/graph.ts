...
export interface DependencyGraph {
  readonly _tag: 'FieldDependencyGraph'
  /**
...
type DependencyGraphCacheEntry = {
  readonly edgesRef: FieldProgram<any>['graph']['edges']
  readonly graph: DependencyGraph
}

const dependencyGraphCache = new WeakMap<FieldProgram<any>, DependencyGraphCacheEntry>()

export const buildDependencyGraph = (program: FieldProgram<any>): DependencyGraph => {
