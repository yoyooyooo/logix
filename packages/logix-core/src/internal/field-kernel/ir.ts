...
const toNodeKind = (step: FieldPlanStep): string => {
  switch (step.kind) {
...
const findEntryForStep = (
  ...
  step: FieldPlanStep,
): FieldEntry<any, string> | undefined => {
...
const getReadsForEntry = (entry: FieldEntry<any, string> | undefined): ReadonlyArray<string> | undefined => {
