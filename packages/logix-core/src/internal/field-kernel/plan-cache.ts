import type { FieldConvergePlanCacheEvidence } from './model.js'
...
export class ConvergePlanCache {
  ...
  private disableReason_: FieldConvergePlanCacheEvidence['disableReason'] | undefined
  ...
  disable(reason: FieldConvergePlanCacheEvidence['disableReason']): void {
  ...
  private disableInternal(reason: FieldConvergePlanCacheEvidence['disableReason']): void {
    this.disabled_ = true
