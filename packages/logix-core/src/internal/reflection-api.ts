...
import type {
  CheckStaticLiveBindingInput,
  StaticLiveBindingIndex,
  StaticLiveBindingIndexDiagnostics,
  StaticLiveBindingDenialReason,
  StaticLiveBindingHeader,
  StaticLiveBindingRequest,
  StaticLiveBindingResult,
} from './reflection/staticLiveBinding.js'
import * as StaticLiveBinding from './reflection/staticLiveBinding.js'
...
export const checkStaticLiveBinding = (
  input: CheckStaticLiveBindingInput,
): StaticLiveBindingResult => StaticLiveBinding.checkStaticLiveBinding(input)

export const createStaticLiveBindingIndex = (
  manifest: RuntimeReflectionManifest,
): StaticLiveBindingIndex => StaticLiveBinding.createStaticLiveBindingIndex(manifest)
