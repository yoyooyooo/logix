 ...
 */
const runtimeRegistry = new WeakMap<ServiceMap.Key<any, PublicModuleRuntime<any, any>>, PublicModuleRuntime<any, any>>()
...
export const registerRuntime = <S, A>(
  tag: ServiceMap.Key<any, PublicModuleRuntime<S, A>>,
  runtime: PublicModuleRuntime<S, A>,
): void => {
  runtimeRegistry.set(tag as ServiceMap.Key<any, PublicModuleRuntime<any, any>>, runtime as PublicModuleRuntime<any, any>)
}

export const unregisterRuntime = (tag: ServiceMap.Key<any, PublicModuleRuntime<any, any>>): void => {
...
export const getRegisteredRuntime = <S, A>(
  ...
  runtimeRegistry.get(tag as ServiceMap.Key<any, PublicModuleRuntime<any, any>>) as PublicModuleRuntime<S, A> | undefined
