...
import type * as Debug from '../../src/internal/debug-api.js'
...
describe('FieldKernel converge auto module overrides (hot switch)', () => {
  it.effect('runtime moduleId override can hot switch and takes effect on next transaction', () =>
    Effect.gen(function* () {
      const moduleId = 'FieldKernelConvergeAuto_ModuleOverrideHotSwitch'
      ...
      yield* Logix.Runtime.setFieldConvergeOverride(runtime, moduleId, { fieldConvergeMode: 'full' })
      ...
      yield* Logix.Runtime.setFieldConvergeOverride(runtime, moduleId, { fieldConvergeMode: 'dirty' })
  ...
  it.effect('provider override beats runtime moduleId override after hot switch', () =>
    Effect.gen(function* () {
      const moduleId = 'FieldKernelConvergeAuto_ModuleOverrideHotSwitch_ProviderWins'
