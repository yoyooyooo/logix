...
import { EffectOpTimelineView } from './EffectOpTimelineView.js'
...
export const DevtoolsShell: React.FC<
  DevtoolsShellProps & { getProgramForModule?: GetProgramForModule }
> = ({ position = 'bottom-left', getProgramForModule }) => {
  const { open, layout, theme } = useDevtoolsState()
  ...
  const panel = open ? (
    <div
      ...
      className="flex flex-col backdrop-blur-xl border rounded-xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.8)] overflow-hidden font-sans"
    >
      <div
        onMouseDown={(e) => {
          e.preventDefault()
