...
import {
  ...
  type RuntimeWorkbenchEvidenceGapInput,
  type RuntimeWorkbenchLiveEvidenceInput,
...
export interface WorkbenchNormalizedInput {
  ...
  readonly liveTruthInputs?: ReadonlyArray<RuntimeWorkbenchLiveEvidenceInput | RuntimeWorkbenchEvidenceGapInput>
  readonly gaps: ReadonlyArray<WorkbenchEvidenceGap>
