...
import type { DevtoolsSettings } from '../../state/index.js'
...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ settings, onUpdate, onClose }) => {
  ...
  const updateNumber = (key: keyof DevtoolsSettings, value: string) => {
      ...
      <div className="flex flex-col gap-2">
        ...
        <label className="flex items-center justify-between gap-2">
          ...
          <input
            ...
            onChange={(e) => updateNumber('eventBufferSize', e.target.value)}
        ...
        <label className="flex items-center justify-between gap-2">
          ...
          <input
            ...
            onChange={(e) => updateNumber('operationWindowMs', e.target.value)}
            className="w-20 px-1 py-0.5 rounded border"
            style={{
              backgroundColor: 'var(--dt-bg-root)',
              borderColor: 'var(--dt-border)',
        ...
        <div className="flex flex-col gap-2">
          <label className="flex items-center justify-between gap-2">
            ...
            <input
              ...
              onChange={(e) => updateNumber('overviewHighlightDurationMs', e.target.value)}
              className="w-20 px-1 py-0.5 rounded border"
              style={{
                backgroundColor: 'var(--dt-bg-root)',
                borderColor: 'var(--dt-border)',
