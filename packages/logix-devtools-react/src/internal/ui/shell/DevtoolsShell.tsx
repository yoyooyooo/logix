...
export const DevtoolsShell: React.FC<DevtoolsShellProps & { getProgramForModule?: GetProgramForModule }> = ({
  ...
  const handleButtonMouseDown = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    // Enter dragging state (avoid frequent storage writes; when isDragging=true, updateLayout won't persist).
    handleLayoutChange({
    ...
    const handleMove = (e: MouseEvent) => {
      ...
      // x / y represents the offset from the bottom-right corner.
