...
export type PlaygroundWorkbenchAction =
  | { readonly _tag: 'projectChanged'; readonly payload: { readonly revision: number; readonly activeFile: string } }
...
export const PlaygroundWorkbench = Logix.Module.make('PlaygroundWorkbench', {
  ...
  reducers: {
    projectChanged: (_state, action, sink) => {
      ...
      return {
        ...
        workspaceRevision: action.payload.revision,
