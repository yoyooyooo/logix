        ...
        const { points, thresholds } = await runMatrixSuite(
          ...
          return {
            ...
            evidence: {
              ...
              'selectorNotify.notifiedTopicCount': moduleCount,
              'selectorNotify.renderCount': 0,
              'selectorNotify.runSyncFallbackCount': 0,
              'selectorNotify.retainedTopicCount': watcherCount,
              'selectorNotify.listenerSnapshotCloneCount': 0,
              'selectorNotify.broadcastFallbackCount': 0,
            },
          }
          },
        )
