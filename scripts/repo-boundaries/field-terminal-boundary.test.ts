...
const guardedFiles = [
  ...
  'apps/docs/content/docs/guide/essentials/field-behaviors.md',
  'apps/docs/content/docs/guide/essentials/field-behaviors.cn.md',
  'apps/docs/content/docs/guide/essentials/flows-and-effects.md',
  'apps/docs/content/docs/guide/essentials/flows-and-effects.cn.md',
  ...
  'apps/docs/content/docs/guide/advanced/concurrency-policy.cn.md',
