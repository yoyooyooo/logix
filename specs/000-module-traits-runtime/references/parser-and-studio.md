...
- Parser / Studio 可通过两种方式复用该逻辑：
  1. 在 Node 环境中直接 import `@logix/core/state-trait.js`，对选定模块执行 build；  
...
- `docs/specs/intent-driven-ai-coding/v3` 中的 SDD / Mapping 文档；  
- `docs/specs/runtime-logix` 中的 Runtime / Flow / Module 说明  
