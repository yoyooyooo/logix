...
> 提示：本文件隶属于已归档的 `specs/002-logix-data-core-dsl` 特性，当前主线已由 `specs/000-module-fields-runtime` 收敛到 `@logixjs/core` 内部的 FieldKernel 数据模型。此处内容只作为早期 Module DSL + `@logixjs/data` 协作模型的参考。
