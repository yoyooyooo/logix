...
> 提示：本 Quickstart 隶属于已归档的 `specs/002-logix-data-core-dsl` 特性，描述的是早期「Module DSL ↔ `@logixjs/data`」集成路径。当前主线已由 FieldKernel / `@logixjs/core` 统一承载字段能力，新示例请参考 `specs/000-module-fields-runtime/quickstart.md`。
