...
本目录用于沉淀 `specs/004-field-bridge-form` 的辅助材料（非主规范正文），包括：
...
- `00-field-stack-narrative.md`：Field/FieldKernel → Module（Form/Query）→ UI（React）链路叙事（自底向上）
- `01-module-placement.md`：领域放置决策（Form vs 独立领域包 vs 最佳实践）
