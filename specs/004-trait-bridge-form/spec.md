...
- 链路叙事（Trait/StateTrait → Domain → UI）：`specs/004-trait-bridge-form/references/00-trait-stack-narrative.md`
- Query 领域规划（与 Form 平行，外链）：`specs/004-trait-bridge-form/references/02-query-domain-plan.md`
