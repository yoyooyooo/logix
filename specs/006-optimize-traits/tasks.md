...
- [ ] T023 更新 runtime 规范文档：Trait 在 Operation Window 内收敛、失败/降级语义、诊断信号与 Devtools 对齐：`docs/specs/runtime-logix/core/05-runtime-implementation.md`、`docs/specs/runtime-logix/core/09-debugging.md`
