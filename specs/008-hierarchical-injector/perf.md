...
> 运行脚本：`pnpm tsx scripts/perf/008-hierarchical-injector.resolveModuleRuntime.ts`

## 运行方式

- 默认：`pnpm tsx scripts/perf/008-hierarchical-injector.resolveModuleRuntime.ts`
- 调整迭代次数：`ITERS=20000 pnpm tsx scripts/perf/008-hierarchical-injector.resolveModuleRuntime.ts`
...
- Command: `pnpm tsx scripts/perf/008-hierarchical-injector.resolveModuleRuntime.ts`
