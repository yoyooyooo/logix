...
- 同步更新 SSoT 与用户文档：`docs/ssot/runtime/logix-core/runtime/05-runtime-implementation.md`、`docs/ssot/runtime/logix-core/observability/09-debugging.md`、`apps/docs/content/docs/**`（围绕 `auto` 默认、证据字段与分档语义），并标注/更新 `specs/007-unify-trait-system/review.md` 中与 013 冲突的口径。
