...
**Branch**: `[027-runtime-observability-hardening]` | **Date**: 2025-12-23 | **Spec**: `/Users/yoyo/Documents/code/personal/logix.worktrees/next-api/specs/027-runtime-observability-hardening/spec.md`
**Input**: Feature specification from `/Users/yoyo/Documents/code/personal/logix.worktrees/next-api/specs/027-runtime-observability-hardening/spec.md`
...
- Answer the following BEFORE starting research, and re-check after Phase 1:
  ...
  - Which `docs/specs/*` specs does it depend on or modify, and are they
    ...
    - 依赖并需要同步校对：`/Users/yoyo/Documents/code/personal/logix.worktrees/next-api/docs/ssot/runtime/logix-core/observability/09-debugging.md`（DevtoolsHub/DevtoolsSnapshot/订阅契约）。如涉及导出协议字段，将对齐 `specs/005-unify-observability-protocol/contracts/*` 的裁决口径。
...
- 决定实例销毁后的派生缓存回收策略（latestStates/latestFieldSummaries）。
