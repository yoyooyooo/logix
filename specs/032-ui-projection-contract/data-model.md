...
- 逻辑插座事实源：`specs/035-module-ports-typeir/contracts/schemas/module-port-spec.schema.json`（PortSpec）
- 映射资产引用：`specs/034-expression-asset-protocol/contracts/schemas/code-asset-ref.schema.json`
