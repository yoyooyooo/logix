...
- [ ] T041 [P] 文档回写（docs-first）：补齐 schemaId/registry pack/schemaRef 术语与约束（避免并行真相源漂移）：`docs/specs/intent-driven-ai-coding/03-assets-and-schemas.md`、`docs/specs/intent-driven-ai-coding/99-glossary-and-ssot.md`（Refs: FR-001, FR-002, NFR-005）
