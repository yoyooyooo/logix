...
- 证据落盘：
  - `specs/073-logix-external-store-tick/perf/browser.before.5aac8782-dirty.darwin-arm64.logix-browser-perf-matrix-v1.default.suite=externalStore.ingest.tickNotify.r1.json`
  - `specs/073-logix-external-store-tick/perf/browser.after.5aac8782-dirty.darwin-arm64.logix-browser-perf-matrix-v1.default.suite=externalStore.ingest.tickNotify.r2.json`
  - `specs/073-logix-external-store-tick/perf/diff.browser.suite=externalStore.ingest.tickNotify.r1__r2.5aac8782-dirty.darwin-arm64.logix-browser-perf-matrix-v1.default.json`
