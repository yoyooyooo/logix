...
- [ ] T004 在平台 SSoT 回写 `ModuleManifest.servicePorts` 的资产定义与 schema 引用 `docs/specs/sdd-platform/ssot/assets/00-assets-and-schemas.md`
...
## Phase 6: Docs（用户文档与 runtime-logix 回链）

- [ ] T021 [P] 更新 `quickstart.md`：对齐真实 API 路径与最小验收步骤 `specs/078-module-service-manifest/quickstart.md`
- [ ] T022 [P] 更新 runtime-logix 参考文档：固化 `services`/`servicePorts`/TrialRun 对齐口径 `.codex/skills/project-guide/references/runtime-logix/logix-core/**`
