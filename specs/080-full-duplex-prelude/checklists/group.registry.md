...
- [ ] `005-unify-observability-protocol` 已按其 tasks/quickstart 达标（入口：`specs/005-unify-observability-protocol/tasks.md`、`specs/005-unify-observability-protocol/quickstart.md`）
...
- [ ] `078-module-service-manifest` 已按其 tasks/quickstart 达标（入口：`specs/078-module-service-manifest/tasks.md`、`specs/078-module-service-manifest/quickstart.md`）
- [ ] `081-platform-grade-parser-mvp` 已按其 tasks/quickstart 达标（入口：`specs/081-platform-grade-parser-mvp/tasks.md`、`specs/081-platform-grade-parser-mvp/quickstart.md`）
- [ ] `082-platform-grade-rewriter-mvp` 已按其 tasks/quickstart 达标（入口：`specs/082-platform-grade-rewriter-mvp/tasks.md`、`specs/082-platform-grade-rewriter-mvp/quickstart.md`）
- [ ] `079-platform-anchor-autofill` 已按其 tasks/quickstart 达标（入口：`specs/079-platform-anchor-autofill/tasks.md`、`specs/079-platform-anchor-autofill/quickstart.md`）
- [ ] `085-logix-cli-node-only` 已按其 tasks/quickstart 达标（入口：`specs/085-logix-cli-node-only/tasks.md`、`specs/085-logix-cli-node-only/quickstart.md`）
- [ ] `083-named-logic-slots` 已按其 tasks/quickstart 达标（入口：`specs/083-named-logic-slots/tasks.md`、`specs/083-named-logic-slots/quickstart.md`）
- [ ] `084-loader-spy-dep-capture` 已按其 tasks/quickstart 达标（入口：`specs/084-loader-spy-dep-capture/tasks.md`、`specs/084-loader-spy-dep-capture/quickstart.md`）
