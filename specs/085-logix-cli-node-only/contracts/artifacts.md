...
> Superseded background only. This artifact naming contract is not current CLI authority.
...
> Old toolbox artifact names are negative-only legacy references for `160`.
