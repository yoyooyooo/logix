...
- **Runtime Control Plane**: 承接 `check / trial / compare`、机器报告与证据比较的 verification 控制面。171 后续新增的 `logix live <task>` 只负责 live runtime collaboration 与 canonical evidence handoff，不拥有 verification verdict。
