...
> **Final cutover note (2026-05-11):** Current Form API spelling and import shape are frozen by `specs/155-form-api-shape/spec.md` and `docs/ssot/form/13-exact-surface-contract.md`. Historical discussion about `useFormList` or Form-owned hook helpers is not current core/domain API.
