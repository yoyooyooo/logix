...
> **Final cutover note (2026-05-11):** `AC3.3` and related candidate names are historical trace. Current authority is `docs/ssot/form/13-exact-surface-contract.md`. Implementation work must preserve the final single-track surface and must not recreate deleted public path/schema helpers or `examples/logix-form-poc/**`.
