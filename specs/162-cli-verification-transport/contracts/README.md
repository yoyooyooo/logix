...
- Runtime-stage results use `primaryReportOutputKey` to reference a `VerificationControlPlaneReport` artifact.
- Pre-control-plane gate failures may use `primaryReportOutputKey` to reference a transport error artifact, which is not report truth.
