...
- Transport witness: `CommandResult` remains transport-only; runtime-stage results point to a `VerificationControlPlaneReport` artifact through `primaryReportOutputKey`, while pre-control-plane gate failures point to a transport error artifact.
