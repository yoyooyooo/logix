# Selector Dirty/Read Overlap Fanout Sentinels Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Prevent selector dirty/read overlap from degenerating into broad topic notify fanout under exact dirty evidence.
...
- Create: `packages/logix-core/test/Runtime/Runtime.selectorNotifyFanout.contract.test.ts`
- Create: `packages/logix-core/test/Runtime/Runtime.selectorBroadcastFallbackReason.contract.test.ts`
