# Field Kernel Dirty Work Tax Wave Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Coordinate a focused FieldKernel dirty-work wave without reopening dispatch shell or RuntimeStore notify work.
...
- Create: `docs/next/field-kernel-dirty-work-tax-wave.md`
- Create: `docs/next/field-kernel-dirty-work-evidence-protocol.md`
